        ...
        if target_files:
            try:
                ...
                for target_file in target_files:
                    ...
                    print(f"已处理 {source_file} -> {target_file}")
                    
                    # 将文件添加到对应的组
                    if 'RX' in target_file:
                        file_groups['RX'].append(target_path)
                    elif 'NF_SPEC' in target_file:
                        file_groups['NF_SPEC'].append(target_path)
                    elif 'NF_OSC' in target_file:
                        file_groups['NF_OSC'].append(target_path)
